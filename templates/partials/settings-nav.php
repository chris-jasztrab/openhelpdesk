...
$settingsNavGroups = [
    ...
    'Automation' => [
        ...
        ['label' => 'Out of Office',      'url' => '/admin/settings/oof',                'icon' => 'bi-person-x',
         'keywords' => 'out of office oof vacation away absence holiday automatic reply reassign coverage outlook mailbox graph unanswered'],
