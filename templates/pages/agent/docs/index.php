...
(function () {
    var idx = [
        ...
        ["Ticket list layout view table inbox card email-style profile", "/agent/help/ticket-list", "Ticket List & Filters"],
        ["Inbox view from subject hover card reply forward add note person sender", "/agent/help/ticket-list", "Ticket List & Filters"],
