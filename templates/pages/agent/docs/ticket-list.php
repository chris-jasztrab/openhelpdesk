...
<p class="text-muted mb-2">From the <em>sender</em> hover card in <strong>Compact</strong> layout, click <strong>Open tickets &amp; mentions</strong> to open a page listing every open ticket that person submitted, <em>plus</em> any open ticket where they were <strong>@mentioned</strong>. The mentioned ones are badged so it&rsquo;s obvious they&rsquo;re not the requester.</p>
