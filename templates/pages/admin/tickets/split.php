...
$breadcrumbs  = [
    ...
    ['label' => '#' . $ticket['id'], 'url' => '/admin/tickets/' . $ticket['id']],
    ['label' => 'Split'],
];
?>
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/admin/tickets/<?= (int) $ticket['id'] ?>" class="btn btn-outline-secondary">
        <i class="bi bi-arrow-left me-1"></i>Cancel
    </a>
</div>

<form method="POST" action="/admin/tickets/<?= (int) $ticket['id'] ?>/split">
    <?= csrfField() ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="/admin/tickets/<?= (int) $ticket['id'] ?>" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </div>
