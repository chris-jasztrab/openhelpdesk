        ...
        <table class="table table-hover align-middle mb-0" id="ticketTable" style="width:100%;visibility:hidden;">
            <thead class="table-light" style="position:sticky;top:0;z-index:5;box-shadow:0 1px 2px rgba(0,0,0,.06);">
                <tr>
                    ...
                    <th style="width:72px;min-width:72px;"><a href="<?= sortUrl('id', $sort, $dir, $sortParams, '/admin/tickets') ?>" class="text-decoration-none text-dark"># <?= sortIcon('id', $sort, $dir) ?></a></th>
                    <th class="subject-col" data-flex-col style="min-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><a href="<?= sortUrl('subject', $sort, $dir, $sortParams, '/admin/tickets') ?>" class="text-decoration-none text-dark">Subject <?= sortIcon('subject', $sort, $dir) ?></a></th>
                    ...
                    <tr style="cursor:pointer;<?= $isRedacted ? 'opacity:0.75;' : '' ?>" onclick="window.location='/admin/tickets/<?= $t['id'] ?>'">
                        ...
                        <td style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="<?= $isRedacted ? 'Confidential' : e($t['subject']) ?>">
                            ...
                            <span class="ld-subject-cell" data-ticket-id="<?= (int) $t['id'] ?>">
                                <a href="/admin/tickets/<?= $t['id'] ?>" class="ld-subject-link text-decoration-none fw-semibold text-dark"<?= $presence ? ' style="color:#b45309;"' : '' ?>>
                                    <?= e($t['subject']) ?>
                                </a>
