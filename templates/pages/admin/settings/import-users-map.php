<?php
$layout       = 'app';
$pageTitle    = 'Map Columns – Import Users';
...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body p-4">
        <p class="text-muted mb-4">
            Match each field to the corresponding column from your CSV file.
        ...
        <form method="POST" action="/admin/settings/import-users/map">
            <?= csrfField() ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="text-muted small"><?= e($field['hint']) ?></div>
                                <?php endif; ?>
                            </td>
                            <td>
