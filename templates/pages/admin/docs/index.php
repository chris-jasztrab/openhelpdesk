...
<div class="row g-3" id="docsCards">
    ...
    $cards = [
        ...
        ['url' => '/admin/docs/automations',     'icon' => 'bi-lightning',       'color' => '#ca8a04', 'bg' => '#fefce8',
         ...
         'desc'  => 'Event-based automation rules, group auto-assignment, time-based escalations, stale-ticket reminders, and out-of-office coverage.'],
        ...
        ['url' => '/admin/docs/csat',            'icon' => 'bi-star',            'color' => '#eab308', 'bg' => '#fefce8',
         'title' => 'Satisfaction Surveys',
         'desc'  => 'Built-in 1–5 star surveys or link to HappyOrNot / SurveyGizmo / Jotform / Typeform via an external URL.'],
...
(function () {
    var idx = [
        ...
        ["Ticket statuses open in progress pending resolved closed waiting", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Configure ticket statuses add custom rename recolor delete reorder", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Ticket status bucket open closed business logic dashboard SLA", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Per-status pauses SLA toggle pending waiting on customer third party", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Default new ticket status default resolved status default closed status promote set", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Ticket status slug permanent immutable label color editable", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Deactivate hide ticket status from dropdowns historical tickets", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Reassign tickets before deleting status reassign-to dropdown", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Built-in seeded ticket statuses cannot delete deactivate only", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ["Ticket status guardrails default holder last in bucket automation reference", "/admin/docs/tickets#ticket-statuses", "Tickets"],
        ...
        ["Ticket list layout view table compact inbox card email-style profile per-user", "/admin/docs/tickets#list-layouts", "Tickets"],
        ["Compact inbox view from subject hover card reply forward add note person sender", "/admin/docs/tickets#list-layouts", "Tickets"],
        ["Card view stacked layout requester avatar new flag SLA age priority status", "/admin/docs/tickets#list-layouts", "Tickets"],
        ["Open tickets and mentions user @mention page submitted scoped visibility", "/admin/docs/tickets#list-layouts", "Tickets"],
        ["Hide confidential column default column picker ticket list", "/admin/docs/tickets#list-layouts", "Tickets"],
        ...
        ["Per-group email templates editing for picker override inherit subject intro button", "/admin/docs/email", "Email and Notifications"],
        ...
        ["SLA counted days weekday Monday Sunday freeze timer per policy", "/admin/docs/sla#counted-days", "SLA Policies"],
        ["Duration units days hours minutes d h m suffix combine roll up 1d 2h 30m", "/admin/docs/sla#duration-units", "SLA Policies"],
        ...
        ["OOF no return date always enabled indefinite message until further notice", "/admin/docs/automations#oof-coverage", "Automations and Escalations"],
        ["View out-of-office status permission oof.view read-only power user", "/admin/docs/automations#oof-coverage", "Automations and Escalations"],
        ...
        ["CSAT satisfaction survey customer rating", "/admin/docs/csat", "Satisfaction Surveys"],
        ["External survey HappyOrNot SurveyGizmo Alchemer Jotform Typeform Microsoft Forms", "/admin/docs/csat", "Satisfaction Surveys"],
        ["CSAT URL placeholders ticket_id user_email subject pre-fill query string", "/admin/docs/csat#placeholders", "Satisfaction Surveys"],
        ["Survey email reopen button single rate experience layout", "/admin/docs/csat#reopen-button", "Satisfaction Surveys"],
        ["CSAT trigger status resolved closed when sent", "/admin/docs/csat", "Satisfaction Surveys"],
        ["External dashboard URL link satisfaction report jump", "/admin/docs/csat#reports", "Satisfaction Surveys"],
        ["Test survey preview send sample CSAT email", "/admin/docs/csat", "Satisfaction Surveys"],
        ...
        ["Audit log prune delete old entries retention cutoff ticket history retained", "/admin/docs/users#audit-log", "Users and Roles"],
        ["Audit log export Excel CSV download active filters unpaged columns", "/admin/docs/users#audit-log", "Users and Roles"],
        ["Audit log source filter ticket timeline history unified pane", "/admin/docs/users#audit-log", "Users and Roles"],
        ["External contacts forwarded ticket auto-provisioned badge filter user list", "/admin/docs/users", "Users and Roles"],
