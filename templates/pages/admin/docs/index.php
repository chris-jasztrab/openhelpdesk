...
(function () {
    var idx = [
        ...
        ["Ticket list layout view table inbox card email-style profile per-user", "/admin/docs/tickets#list-layouts", "Tickets"],
        ["Inbox view from subject hover card reply forward add note person sender", "/admin/docs/tickets#list-layouts", "Tickets"],
