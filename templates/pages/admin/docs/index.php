...
(function () {
    var idx = [
        ...
        ["Required field hide from portal users visibility eye-slash", "/admin/docs/tickets#form-builder", "Tickets"],
        ["Field scope global specific ticket type association which form", "/admin/docs/tickets#form-builder", "Tickets"],
        ["Scope pill global tag indigo grey row indicator", "/admin/docs/tickets#form-builder", "Tickets"],
        ["Show field on all ticket types only specific segmented switch", "/admin/docs/tickets#form-builder", "Tickets"],
        ["Preview as filter chip strip ticket type form builder", "/admin/docs/tickets#form-builder", "Tickets"],
