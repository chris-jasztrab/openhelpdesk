...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.1);">
    ...
    <tr>
        <td style="padding:32px;">
            <h2 style="margin:0 0 8px; font-size:18px; color:#1e293b;">Confidential Status Removed</h2>
            <p style="margin:0 0 24px; font-size:14px; color:#64748b;"><?= $introText ?? 'The confidential flag has been removed from an entity you are associated with.' ?></p>

            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                <tr>
                    <td style="padding:8px 12px; background:#fee2e2; border:1px solid #fca5a5; border-bottom:none; border-radius:8px 8px 0 0; font-size:13px; color:#991b1b; font-weight:600;">Action Details</td>
                </tr>
                <tr>
                    <td style="padding:16px; border:1px solid #fca5a5; border-radius:0 0 8px 8px;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px; color:#334155;">
                            <tr>
                                ...
                                <td style="padding:4px 0; font-weight:600; color:#dc2626;">Confidential flag removed</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding:4px 0; color:#64748b; vertical-align:top;">Changed By</td>
            ...
            <div style="padding:12px 16px; background:#fef3c7; border:1px solid #fbbf24; border-radius:8px; margin-bottom:24px; font-size:13px; color:#92400e;">
                <strong>What this means:</strong> The security protections previously associated with this <?= htmlspecialchars($targetType, ENT_QUOTES, 'UTF-8') ?> (re-authentication gates, access alerts, ticket redaction) are no longer active.
            </div>
