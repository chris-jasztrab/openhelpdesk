...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.1);">
    ...
    <!-- Header -->
    <tr>
        <td style="background:linear-gradient(135deg,#78350f,#b45309); padding:20px 32px;">
            <h1 style="margin:0; color:#ffffff; font-size:20px; font-weight:700;">
                <span style="display:inline-block; vertical-align:middle; background:#ffffff; color:#b45309; border-radius:4px; padding:2px 8px; font-size:12px; font-weight:700; letter-spacing:.05em; margin-right:8px;">STALE</span>
                OpenHelpDesk
            </h1>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:32px;">
            ...
            <p style="margin:0 0 24px; font-size:14px; color:#64748b;"><?= $introText ?? 'A ticket in a group you manage has had no activity recently.' ?></p>

            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                <tr>
                    <td style="padding:8px 12px; background:#fffbeb; border:1px solid #fde68a; border-bottom:none; border-radius:8px 8px 0 0; font-size:13px; color:#92400e; font-weight:600;">Stale Alert</td>
                </tr>
                <tr>
                    <td style="padding:16px; border:1px solid #fde68a; border-radius:0 0 8px 8px;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px; color:#334155;">
                            <tr>
                                <td style="padding:4px 0; width:150px; color:#64748b; vertical-align:top;">Hours since update</td>
                                <td style="padding:4px 0;"><strong><?= (int) $hoursSinceUpdate ?></strong> hours</td>
                            </tr>
                            <tr>
                                <td style="padding:4px 0; color:#64748b; vertical-align:top;">Stale threshold</td>
                                <td style="padding:4px 0;"><?= (int) $thresholdHours ?> hours</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="padding:4px 0;">
                                    ...
                                    <?php else: ?>
                                        <strong style="color:#b45309;">Unassigned</strong>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding:16px; border:1px solid #e2e8f0; border-radius:0 0 8px 8px;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px; color:#334155;">
                            ...
                            <tr>
                                <td style="padding:4px 0; width:100px; color:#64748b; vertical-align:top;">Group</td>
