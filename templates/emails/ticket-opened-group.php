...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 1px 3px rgba(0,0,0,.1);">
    ...
    <tr>
        <td style="padding:32px;">
            ...
            <div style="margin:0 0 24px; font-size:14px; color:#64748b;"><?= $introText ?? 'A new support ticket has been submitted.' ?></div>
                ...
                <tr>
                    <td style="padding:16px; border:1px solid #e2e8f0; border-radius:0 0 8px 8px;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px; color:#334155;">
                            <tr>
                                <td style="padding:4px 0; width:100px; color:#64748b; vertical-align:top;">Status</td>
                                <td style="padding:4px 0;">
                                    <span style="display:inline-block; padding:2px 10px; border-radius:12px; background:#dbeafe; color:#1e40af; font-size:12px; font-weight:600;">Open</span>
                                </td>
                            </tr>
                            <?php if (!empty($submitterName)): ?>
                            <tr>
                                <td style="padding:4px 0; color:#64748b; vertical-align:top;">Submitted by</td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                ...
                <tr>
                    <td style="padding:16px; border:1px solid #e2e8f0; border-radius:0 0 8px 8px; font-size:14px; color:#334155; line-height:1.6;"><?= emailContent($description) ?></td>
                </tr>
            </table>
