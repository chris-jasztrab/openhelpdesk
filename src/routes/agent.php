...
$validHelpPages = ['dashboard', 'wallboard', 'ticket-list', 'kanban', 'working-tickets', 'floor', 'canned-responses', 'sla'];
...
$router->post('/agent/kb/articles/{slug}/feedback', function (array $p) {
    ...
    // other POST in this file has. Without it any page an agent visits could
